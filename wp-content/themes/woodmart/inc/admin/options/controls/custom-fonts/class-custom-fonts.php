	...
	public function render_control() {
		...
		?>
			<div id="<?php echo esc_attr( $this->get_id() ); ?>" data-id="<?php echo esc_attr( $this->get_id() ); ?>" data-key="<?php echo esc_attr( $key ); ?>" class="xts-custom-fonts">
				...
				<div class="xts-custom-fonts-btn-add xts-inline-btn xts-color-primary dashicons-plus-alt"><?php esc_html_e( 'Add font', 'woodmart' ); ?></div>
	...
	public function section_template( $index, $section_value ) {
		...
		?>
			...
			<div class="xts-custom-fonts-section<?php echo esc_attr( $hide_class ); ?>" data-id="<?php echo esc_attr( $this->get_id() ); ?>-<?php echo esc_attr( $index ); ?>">
				...
				<div class="xts-custom-fonts-btn-remove xts-inline-btn xts-color-warning dashicons-trash"><?php esc_html_e( 'Remove', 'woodmart' ); ?></div>
		...
		?>
			<div class="xts-custom-fonts-field xts-upload-control">
				...
				<div class="xts-upload-btns">
					...
					<button class="xts-btn xts-color-warning xts-remove-upload-btn<?php echo ( isset( $url ) && ! empty( $url ) ) ? ' xts-active' : ''; ?>"><?php esc_html_e( 'Remove', 'woodmart' ); ?></button>
