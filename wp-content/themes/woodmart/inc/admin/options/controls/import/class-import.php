...
class Import extends Field {
	...
	public function render_control() {
		?>
			...
			<button class="xts-save-options-btn xts-btn xts-color-primary" type="submit" name="xts-<?php echo esc_attr( $this->opt_name ); ?>-options[import-btn]" value="1"><?php esc_html_e( 'Import', 'woodmart' ); ?></button>
			<a class="xts-save-options-btn xts-btn xts-color-primary" href="<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>?action=xts_download_export_options&secret=<?php echo esc_attr( $this->generete_secret() ); ?>"><?php esc_html_e( 'Export options', 'woodmart' ); ?></a>
		<?php
	}
