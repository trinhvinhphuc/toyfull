...
class Instagram_Api extends Field {
		...
		?>
			<div class="xts-upload-btns">
				...
				<?php if ( $instagram_access_token ) : ?>
					<a href="<?php echo $this->get_return_url() . '&instagram_account_disconnect'; ?>" class="xts-btn xts-color-warning xts-remove-upload-btn">
	...
	public function get_return_url() {
		return admin_url( 'admin.php' ) . '?page=xtemos_options&tab=api_integrations_section';
	}
