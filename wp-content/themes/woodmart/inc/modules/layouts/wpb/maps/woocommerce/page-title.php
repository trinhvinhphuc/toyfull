...
if ( ! function_exists( 'woodmart_vc_map_page_title' ) ) {
	/**
	 * Page title map.
	 */
	function woodmart_vc_map_page_title() {
		if ( ! shortcode_exists( 'woodmart_page_title' ) ) {
			return;
		}
	...
	add_action( 'vc_before_init', 'woodmart_vc_map_page_title' );
}
