...
if ( ! function_exists( 'woodmart_vc_map_single_compare_button' ) ) {
	/**
	 * Compare button map.
	 */
	function woodmart_vc_map_single_compare_button() {
		if ( ! shortcode_exists( 'woodmart_single_product_compare_button' ) || ! Main::is_layout_type( 'single_product' ) ) {
			return;
		}
	...
	add_action( 'vc_before_init', 'woodmart_vc_map_single_compare_button' );
}
