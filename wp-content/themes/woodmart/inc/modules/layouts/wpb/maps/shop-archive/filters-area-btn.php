...
if ( ! function_exists( 'woodmart_vc_map_shop_archive_filters_area_btn' ) ) {
	/**
	 * Filters area button map.
	 */
	function woodmart_vc_map_shop_archive_filters_area_btn() {
		if ( ! shortcode_exists( 'woodmart_shop_archive_filters_area_btn' ) || ! Main::is_layout_type( 'shop_archive' ) ) {
			return;
		}
	...
	add_action( 'vc_before_init', 'woodmart_vc_map_shop_archive_filters_area_btn' );
}
