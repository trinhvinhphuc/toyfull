...
if ( ! function_exists( 'woodmart_vc_map_single_product_short_description' ) ) {
	/**
	 * Short description map.
	 */
	function woodmart_vc_map_single_product_short_description() {
		if ( ! shortcode_exists( 'woodmart_single_product_short_description' ) || ! Main::is_layout_type( 'single_product' ) ) {
			return;
		}
	...
	add_action( 'vc_before_init', 'woodmart_vc_map_single_product_short_description' );
}
