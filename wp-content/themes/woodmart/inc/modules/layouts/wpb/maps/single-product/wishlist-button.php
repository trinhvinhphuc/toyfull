...
if ( ! function_exists( 'woodmart_vc_map_single_wishlist_button' ) ) {
	/**
	 * Wishlist button map.
	 */
	function woodmart_vc_map_single_wishlist_button() {
		if ( ! shortcode_exists( 'woodmart_single_product_wishlist_button' ) || ! Main::is_layout_type( 'single_product' ) ) {
			return;
		}
	...
	add_action( 'vc_before_init', 'woodmart_vc_map_single_wishlist_button' );
}
