...
if ( ! function_exists( 'woodmart_vc_map_checkout_shipping_details_form' ) ) {
	/**
	 * Shipping details map.
	 */
	function woodmart_vc_map_checkout_shipping_details_form() {
		if ( ! shortcode_exists( 'woodmart_checkout_shipping_details_form' ) || ! Main::is_layout_type( 'checkout_form' ) ) {
			return;
		}
	...
	add_action( 'vc_before_init', 'woodmart_vc_map_checkout_shipping_details_form' );
}
