...
if ( ! function_exists( 'woodmart_vc_map_shop_archive_active_filters' ) ) {
	/**
	 * Active filters map.
	 */
	function woodmart_vc_map_shop_archive_active_filters() {
		if ( ! shortcode_exists( 'woodmart_shop_archive_active_filters' ) || ! Main::is_layout_type( 'shop_archive' ) ) {
			return;
		}
	...
	add_action( 'vc_before_init', 'woodmart_vc_map_shop_archive_active_filters' );
}
